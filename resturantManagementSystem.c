...
int main()
{
    heada = createadmin(heada,1,"Chicken Biriyani",280);
    heada = createadmin(heada,2,"Chicken starters",120);
    heada = createadmin(heada,3,"Chicken Fried Rice",180);
    heada = createadmin(heada,4,"Oreo Milkshake",180);
    heada = createadmin(heada,5,"French Fries",90);
